...
public class NacosConsumerApplication {
    ...
    class HelloController {
        ...
        public String info() {
            ...
            String instanceInfo = discoveryClient.getInstances(serviceName).stream().map(instance -> instance.getInstanceId() + "," + instance.getServiceId() + "," + instance.getHost() + "," + instance.getPort() + "<br>").collect(Collectors.joining());
